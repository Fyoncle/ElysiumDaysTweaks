...
while providing compatibility between mods.
...
- Netherite Horse Armor Recipe for [Simple Netherite Horse Armor](https://modrinth.com/mod/simple-netherite-horse-armor)
  Mod
- Podzol Recipe
...
- Fixes an issue where [The Lost Castle](https://modrinth.com/mod/the-lost-castle) mod doesn't grant the Eye Spy
  advancement
...
- Removal of [Icons](https://modrinth.com/resourcepack/icons) Food Tooltips (due to it being extra
  alongside [AppleSkin](https://modrinth.com/mod/appleskin)'s tooltips)
